...
dataDir = [dataDir '202108291112_antpNSRC3_48YG4CAAXmCh_2um_5pc_10mpf_lav3fac2_e1e2e3e5mutant/e1'] ;
...
% file16name = 'wt_T%03d' ;     
file16name = 'e1_1211_mutant_T%02d' ;     
...
for t = [2:31] ; % xp.fileMeta.timePoints(1:end)
    xp.setFileMeta(fileMeta);
    xp.setExpMeta(expMeta);
    xp.initNew();
