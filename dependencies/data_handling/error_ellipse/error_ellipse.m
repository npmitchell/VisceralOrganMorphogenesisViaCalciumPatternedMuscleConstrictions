function [h, ellip]=error_ellipse(varargin)
...
% Returns
% -------
% h : handle for figure object
% ellip : coordinates of ellipse points
%
% some edits NPMitchell 2021
...
elseif r==2 && c==2
  ...
  ellip = [scale*(x0+k*x),scale*(y0+k*y)] ;
  set(h1,'zdata',z+1)
  if nargout
    h=h1;
  end
