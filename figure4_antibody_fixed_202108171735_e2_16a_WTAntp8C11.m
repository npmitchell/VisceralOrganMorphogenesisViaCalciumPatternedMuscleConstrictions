...
% temporary path def
cd /mnt/data/antibodies_lightsheet/48YGAL4CAAXmCh_antp8C11_1t50/202108171735_e2_16a_1p2um_0p3ms0p5ms_3mWGFP_15mWRFP/data/
dataDir = pwd;
...
if overwrite_masterSettings || ~exist('./masterSettings.mat', 'file')
    ...
    scale = [0.7 0.1] ;      % scale for conversion to 16 bit
...
% THEN RAN
command_part2 = ['python /mnt/data/code/morphsnakes_wrapper/morphsnakes_wrapper/run_morphsnakes.py -i fixed_sample_combined_Probabilities.h5 -o /mnt/data/antibodies_lightsheet/48YGAL4CAAXmCh_antp8C11_1t50/202108171735_e2_16a_1p2um_0p3ms0p5ms_3mWGFP_15mWRFP/data/msls_output -prenu -5 -presmooth 1 -ofn_ply mesh_ms_000001.ply -ofn_ls msls_000001.h5 -l1 1 -l2 1 -nu 0.5 -postnu 1 -smooth 4 -postsmooth 3 -exit 0.000010000 -channel 1 -dtype h5 -permute czyx -ss 4 -include_boundary_faces -init_ls /mnt/data/antibodies_lightsheet/48YGAL4CAAXmCh_antp8C11_1t50/202108171735_e2_16a_1p2um_0p3ms0p5ms_3mWGFP_15mWRFP/data/msls_output/msls_initguess.h5 -save -rad0 10 -n 14']
...
if false && ~exist(preSmoothMeshfn, 'file')
